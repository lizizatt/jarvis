...
- [ ] HTOP style processor and memory load display using dither-kit, widget on top of homepage replacing functionless top bar, which can be clicked for a more detailed full screen system performance view.  Have a subagent look at screenshots of each until it is satisfied with the sleek, professional, and usable mobile experience.
